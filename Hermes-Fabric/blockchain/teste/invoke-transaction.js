...
const invokeChaincode = async function(peerNames, channelName, chaincodeName, fcn, args, username, org_name) {
	process.stdout.write("To aqui desgraçaa");
	...
	try {
		...
		const request = {
			targets: peer0.inmetro.com,
			chaincodeId: mycc,
			fcn: insertMeasurement,
			args: "{\"id\":\"666\",\"sensor\":\"DHT\",\"value\":24.7,\"Timestamp\":0.75,\"location\":\"laboratorio\",\"physicalQuantity\":\"Temperatura\"}",
			chainId: mychannel,
			txId: "666"
		};
