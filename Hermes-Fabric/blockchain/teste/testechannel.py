...
cli = Client(net_profile="testeconnection2.json")
org1_admin = cli.get_user(org_name='inmetro.com.com', name='Admin')

# Create a New Channel, the response should be true if succeed
response = loop.run_until_complete(cli.channel_create(
            orderer='orderer.inmetro.com',
            channel_name='mychannel',
            requestor=org1_admin,
            config_yaml='docker-compose-cli.yaml',
